...
export const EMPTY_SUBMIT_UNIT_ERROR_DESCRIPTION = 'Please select a Unit before submitting.';
export const EMPTY_SUBMIT_UNIT_ERROR_TITLE = 'No Unit selected';
...
export const LOAD_UNITS_ERROR_DESCRIPTION = 'There was an error retrieving the units.  Please try refreshing the page.';
