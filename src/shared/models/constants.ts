...
export const ADD_FOI_INTERESTED_PARTY_ERROR_DESCRIPTION = 'Something went wrong while adding the interested party. Please try again.';
export const ADD_CAMPAIGN_SUCCESS = 'The campaign was added successfully';
export const ADD_FOI_INTERESTED_PARTY_SUCCESS = 'The interested party was added successfully';
export const DUPLICATE_CAMPAIGN_DESCRIPTION = 'A campaign with those details already exists';
export const DUPLICATE_FOI_INTERESTED_PARTY_DESCRIPTION = 'An interested with those details already exists';
export const AMEND_CAMPAIGN_ERROR_DESCRIPTION = 'Something went wrong while amending the campaign. Please try again.';
export const AMEND_FOI_INTERESTED_PARTY_ERROR_DESCRIPTION = 'Something went wrong while amending the interested party. Please try again.';
export const AMEND_CAMPAIGN_SUCCESS = 'The campaign was amended successfully';
export const AMEND_FOI_INTERESTED_PARTY_SUCCESS = 'The FOI interested party was amended successfully';
...
export const LOAD_FOI_INTERESTED_PARTIES_ERROR_DESCRIPTION = 'There was an error retrieving FOI interested parties.  Please try refreshing the page.';
