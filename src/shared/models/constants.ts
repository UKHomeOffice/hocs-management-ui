...
export const ADD_FOI_ACCOUNT_MANAGER_ERROR_DESCRIPTION = 'Something went wrong while adding the account manager. Please try again.';
export const ADD_CAMPAIGN_SUCCESS = 'The campaign was added successfully';
export const ADD_FOI_ACCOUNT_MANAGER_SUCCESS = 'The account manager was added successfully';
export const DUPLICATE_CAMPAIGN_DESCRIPTION = 'A campaign with those details already exists';
export const DUPLICATE_FOI_ACCOUNT_MANAGER_DESCRIPTION = 'An account manager with those details already exists';
export const AMEND_CAMPAIGN_ERROR_DESCRIPTION = 'Something went wrong while amending the campaign. Please try again.';
export const AMEND_FOI_ACCOUNT_MANAGER_ERROR_DESCRIPTION = 'Something went wrong while amending the account manager. Please try again.';
export const AMEND_CAMPAIGN_SUCCESS = 'The campaign was amended successfully';
export const AMEND_FOI_ACCOUNT_MANAGER_SUCCESS = 'The FOI account manager was amended successfully';
...
export const LOAD_FOI_ACCOUNT_MANAGERS_ERROR_DESCRIPTION = 'There was an error retrieving FOI account.  Please try refreshing the page.';
