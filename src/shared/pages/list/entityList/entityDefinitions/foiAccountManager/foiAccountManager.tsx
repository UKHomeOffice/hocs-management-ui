export default {
    ...
    messages: {
        LOAD_ENTITIES_ERROR: 'There was an error retrieving FOI account managers.  Please try refreshing the page.',
        AMEND_ENTITY_ERROR_DESCRIPTION: 'Something went wrong while amending the account manager. Please try again.',
        AMEND_ENTITY_SUCCESS: 'The FOI account manager was amended successfully',
