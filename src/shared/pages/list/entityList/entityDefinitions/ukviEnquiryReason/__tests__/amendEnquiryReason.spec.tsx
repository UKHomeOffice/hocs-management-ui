...
describe('when the ukviEnquiryReason amendEntity component is mounted', () => {
    ...
    it('should display an error if the call to retrieve item details fails', async () => {
        ...
        await waitFor(() => {
            expect(setMessageSpy).toHaveBeenCalledWith({ title: GENERAL_ERROR_TITLE,
        ...
        describe('and the service call is successful', () => {
            it('should redirect to the home page', async () => {
                ...
                await waitFor(() => {
                    ...
                    expect(history.push).toHaveBeenCalledWith('/manage-mpam-campaigns', { successMessage: 'The enquiry reason was amended successfully' });
                });
            });
